...
var o10653 = temp__5802__auto__;
var temp__5802__auto____$1 = (o10653["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o10654 = temp__5802__auto____$1;
return (o10654["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9980__auto__ = f;
return (o__9980__auto__["toString"]).call(o__9980__auto__);
} else {
return "";
}
}catch (e10655){var _ = e10655;
return "";
}});
...
try{var o__9980__auto___10657 = t;
(o__9980__auto___10657["cljs$lang$ctorPrWriter"]).call(o__9980__auto___10657,t,writer);
}catch (e10656){var __10658 = e10656;
}
...
var char_code = (function (){var o__9980__auto__ = (new String(char$));
return (o__9980__auto__["charCodeAt"]).call(o__9980__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9980__auto__ = String;
return (o__9980__auto__["fromCharCode"]).call(o__9980__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10659 = num_code;
switch (G__10659) {
case (1):
return (185);
...
var o__9980__auto__ = String;
return (o__9980__auto__["fromCharCode"]).call(o__9980__auto__,superscript_code);
});
/**
...
}catch (e10661){var _e__9987__auto__ = e10661;
return false;
}})())){
...
var vec__10662 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10662,(0),null);
...
var len__5726__auto___10671 = arguments.length;
var i__5727__auto___10672 = (0);
while(true){
if((i__5727__auto___10672 < len__5726__auto___10671)){
args__5732__auto__.push((arguments[i__5727__auto___10672]));

var G__10673 = (i__5727__auto___10672 + (1));
i__5727__auto___10672 = G__10673;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10667){
var vec__10668 = p__10667;
var ns_detector = cljs.core.nth.call(null,vec__10668,(0),null);
...
var G__10674 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10675 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10674;
remaining_tokens = G__10675;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10665){
var G__10666 = cljs.core.first.call(null,seq10665);
var seq10665__$1 = cljs.core.next.call(null,seq10665);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10666,seq10665__$1);
}));
...
var vec__10679 = cljs.core.split_with.call(null,(function (p1__10678_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10678_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10679,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10679,(1),null);
...
var vec__10685 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10685,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10685,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10688 = cljs.core.rest.call(null,remaining_tokens);
var G__10689 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10688;
name_tokens = G__10689;
continue;
} else {
...
var vec__10692 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10692,(0),null);
var arity = cljs.core.nth.call(null,vec__10692,(1),null);
var vec__10695 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10695,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10695,(1),null);
var vec__10698 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10698,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10698,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10698,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10698,(3),null);
...
var vec__10704 = result;
var munged_ns = cljs.core.nth.call(null,vec__10704,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10704,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10704,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10704,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10704,(4),null);
var arity = cljs.core.nth.call(null,vec__10704,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__10708 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__10708,(0),null);
var args = cljs.core.nth.call(null,vec__10708,(1),null);
var vec__10711 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10711,(0),null);
var name = cljs.core.nth.call(null,vec__10711,(1),null);
...
var G__10714 = (arity + (1));
var G__10715 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10716){
var vec__10717 = p__10716;
var arity = cljs.core.nth.call(null,vec__10717,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10717,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10720_SHARP_){
return cljs.core.get.call(null,arities,p1__10720_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__10721_SHARP_){
return cljs.core.drop.call(null,(2),p1__10721_SHARP_);
}),sorted_infos);
...
args__5732__auto__.push((arguments[i__5727__auto___10729]));
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10724){
var vec__10725 = p__10724;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10725,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10722){
var G__10723 = cljs.core.first.call(null,seq10722);
var seq10722__$1 = cljs.core.next.call(null,seq10722);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10723,seq10722__$1);
}));
...
var map__10733 = options;
var map__10733__$1 = cljs.core.__destructure_map.call(null,map__10733);
var include_ns_QMARK_ = cljs.core.get.call(null,map__10733__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10733__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10733__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10733__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10734 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10734,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10734,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10734,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10734,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10734,(4),null);
var arity = cljs.core.nth.call(null,vec__10734,(5),null);
...
var o__9980__auto__ = f;
return (o__9980__auto__["getBasis"]).call(o__9980__auto__);
});
/**
...
}catch (e10737){var _e__9987__auto__ = e10737;
...
var G__10738 = (obj[cljs.core.first.call(null,path)]);
var G__10739 = cljs.core.rest.call(null,path);
obj = G__10738;
path = G__10739;
continue;
} else {
...
var _STAR_ = (function (accum,p__10740){
var vec__10741 = p__10740;
var bit = cljs.core.nth.call(null,vec__10741,(0),null);
var protocol = cljs.core.nth.call(null,vec__10741,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10744){
var vec__10745 = p__10744;
var ns = cljs.core.nth.call(null,vec__10745,(0),null);
var name = cljs.core.nth.call(null,vec__10745,(1),null);
var selector = cljs.core.nth.call(null,vec__10745,(2),null);
...
var post_process = (function (p__10749){
var vec__10750 = p__10749;
var munged_name = cljs.core.nth.call(null,vec__10750,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10750,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10748_SHARP_){
return (obj[cljs.core.first.call(null,p1__10748_SHARP_)]);
}),sorted_matches);
