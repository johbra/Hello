...
}catch (e13255){var _e = e13255;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___13257 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___13257)){
var seen_errors_13258 = temp__5802__auto___13257;
if(cljs.core.truth_(seen_errors_13258.has(self))){
} else {
seen_errors_13258.add(self);

var temp__5804__auto___13259 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___13259)){
var sense_13260 = temp__5804__auto___13259;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_13260)].join(''));
} else {
}
}
} else {
