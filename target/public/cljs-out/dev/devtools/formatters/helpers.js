...
var G__10755 = devtools.prefs.pref.call(null,v);
v = G__10755;
continue;
} else {
return v;
...
}catch (e10756){var _e__9987__auto__ = e10756;
return false;
}})();
...
}catch (e10758){var _e__9987__auto__ = e10758;
return false;
}})();
...
}catch (e10760){var _e__9987__auto__ = e10760;
return false;
}}
}
});
...
var vec__10762 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10762,(0),null);
var name = cljs.core.nth.call(null,vec__10762,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10765_SHARP_);
}),template);
});
