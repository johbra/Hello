...
var o10835 = temp__5802__auto__;
var temp__5802__auto____$1 = (o10835["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o10836 = temp__5802__auto____$1;
return (o10836["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10193__auto__ = f;
return (o__10193__auto__["toString"]).call(o__10193__auto__);
} else {
return "";
}
}catch (e10837){var _ = e10837;
return "";
}});
...
try{var o__10193__auto___10839 = t;
(o__10193__auto___10839["cljs$lang$ctorPrWriter"]).call(o__10193__auto___10839,t,writer);
}catch (e10838){var __10840 = e10838;
}
...
var char_code = (function (){var o__10193__auto__ = (new String(char$));
return (o__10193__auto__["charCodeAt"]).call(o__10193__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10193__auto__ = String;
return (o__10193__auto__["fromCharCode"]).call(o__10193__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10841 = num_code;
switch (G__10841) {
case (1):
return (185);
...
var o__10193__auto__ = String;
return (o__10193__auto__["fromCharCode"]).call(o__10193__auto__,superscript_code);
});
/**
...
}catch (e10843){var _e__10200__auto__ = e10843;
return false;
}})())){
...
var vec__10844 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10844,(0),null);
...
args__5732__auto__.push((arguments[i__5727__auto___10854]));
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10849){
var vec__10850 = p__10849;
var ns_detector = cljs.core.nth.call(null,vec__10850,(0),null);
...
var G__10856 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10857 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10856;
remaining_tokens = G__10857;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10847){
var G__10848 = cljs.core.first.call(null,seq10847);
var seq10847__$1 = cljs.core.next.call(null,seq10847);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10848,seq10847__$1);
}));
...
var vec__10861 = cljs.core.split_with.call(null,(function (p1__10860_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10860_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10861,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10861,(1),null);
...
var vec__10867 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10867,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10867,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10870 = cljs.core.rest.call(null,remaining_tokens);
var G__10871 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10870;
name_tokens = G__10871;
continue;
} else {
...
var vec__10874 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10874,(0),null);
var arity = cljs.core.nth.call(null,vec__10874,(1),null);
var vec__10877 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10877,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10877,(1),null);
var vec__10880 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10880,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10880,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10880,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10880,(3),null);
...
var vec__10886 = result;
var munged_ns = cljs.core.nth.call(null,vec__10886,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10886,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10886,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10886,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10886,(4),null);
var arity = cljs.core.nth.call(null,vec__10886,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__10890 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__10890,(0),null);
var args = cljs.core.nth.call(null,vec__10890,(1),null);
var vec__10893 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10893,(0),null);
var name = cljs.core.nth.call(null,vec__10893,(1),null);
...
var G__10896 = (arity + (1));
var G__10897 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10898){
var vec__10899 = p__10898;
var arity = cljs.core.nth.call(null,vec__10899,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10899,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10902_SHARP_){
return cljs.core.get.call(null,arities,p1__10902_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__10903_SHARP_){
return cljs.core.drop.call(null,(2),p1__10903_SHARP_);
}),sorted_infos);
...
args__5732__auto__.push((arguments[i__5727__auto___10911]));
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10906){
var vec__10907 = p__10906;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10907,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10904){
var G__10905 = cljs.core.first.call(null,seq10904);
var seq10904__$1 = cljs.core.next.call(null,seq10904);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10905,seq10904__$1);
}));
...
var G__10913 = arg;
var G__10913__$1 = (((G__10913 instanceof cljs.core.Keyword))?G__10913.fqn:null);
switch (G__10913__$1) {
...
var map__10915 = options;
var map__10915__$1 = cljs.core.__destructure_map.call(null,map__10915);
var include_ns_QMARK_ = cljs.core.get.call(null,map__10915__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10915__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10915__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10915__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10916 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10916,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10916,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10916,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10916,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10916,(4),null);
var arity = cljs.core.nth.call(null,vec__10916,(5),null);
...
var o__10193__auto__ = f;
return (o__10193__auto__["getBasis"]).call(o__10193__auto__);
});
/**
...
}catch (e10919){var _e__10200__auto__ = e10919;
...
var G__10920 = (obj[cljs.core.first.call(null,path)]);
var G__10921 = cljs.core.rest.call(null,path);
obj = G__10920;
path = G__10921;
continue;
} else {
...
var _STAR_ = (function (accum,p__10922){
var vec__10923 = p__10922;
var bit = cljs.core.nth.call(null,vec__10923,(0),null);
var protocol = cljs.core.nth.call(null,vec__10923,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10926){
...
var selector = cljs.core.nth.call(null,vec__10927,(2),null);
...
var post_process = (function (p__10931){
var vec__10932 = p__10931;
var munged_name = cljs.core.nth.call(null,vec__10932,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10932,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10930_SHARP_){
return (obj[cljs.core.first.call(null,p1__10930_SHARP_)]);
}),sorted_matches);
