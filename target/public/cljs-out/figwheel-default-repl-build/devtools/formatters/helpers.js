...
var G__10937 = devtools.prefs.pref.call(null,v);
v = G__10937;
continue;
} else {
return v;
...
}catch (e10938){var _e__10200__auto__ = e10938;
return false;
}})();
...
}catch (e10940){var _e__10200__auto__ = e10940;
return false;
}})();
...
}catch (e10942){var _e__10200__auto__ = e10942;
return false;
}}
}
});
...
var vec__10944 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10947_SHARP_);
}),template);
});
