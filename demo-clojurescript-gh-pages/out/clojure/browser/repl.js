...
var seq__596_600 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__597_601 = null;
var count__598_602 = (0);
var i__599_603 = (0);
while(true){
if((i__599_603 < count__598_602)){
var str_604 = cljs.core._nth.call(null,chunk__597_601,i__599_603);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_604})));


var G__605 = seq__596_600;
var G__606 = chunk__597_601;
var G__607 = count__598_602;
var G__608 = (i__599_603 + (1));
seq__596_600 = G__605;
chunk__597_601 = G__606;
count__598_602 = G__607;
i__599_603 = G__608;
continue;
} else {
var temp__5804__auto___609 = cljs.core.seq.call(null,seq__596_600);
if(temp__5804__auto___609){
var seq__596_610__$1 = temp__5804__auto___609;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__596_610__$1)){
var c__5525__auto___611 = cljs.core.chunk_first.call(null,seq__596_610__$1);
var G__612 = cljs.core.chunk_rest.call(null,seq__596_610__$1);
var G__613 = c__5525__auto___611;
var G__614 = cljs.core.count.call(null,c__5525__auto___611);
var G__615 = (0);
seq__596_600 = G__612;
chunk__597_601 = G__613;
count__598_602 = G__614;
i__599_603 = G__615;
continue;
} else {
var str_616 = cljs.core.first.call(null,seq__596_610__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_616})));


var G__617 = cljs.core.next.call(null,seq__596_610__$1);
var G__618 = null;
var G__619 = (0);
var G__620 = (0);
seq__596_600 = G__617;
chunk__597_601 = G__618;
count__598_602 = G__619;
i__599_603 = G__620;
continue;
}
} else {
...
var script__$1 = (function (){var G__625 = script;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__625,"type","text/javascript");

clojure.browser.repl.goog$module$goog$object.set.call(null,G__625,"onload",onload);

clojure.browser.repl.goog$module$goog$object.set.call(null,G__625,"onreadystatechange",onload);

return G__625;
})();
if((opt_sourceText == null)){
var G__626 = script__$1;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__626,"src",src);

return G__626;
} else {
var G__627 = script__$1;
goog.dom.setTextContent(G__627,opt_sourceText);
...
var path_628 = goog.debugLoader_.getPathFromDeps_(src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,path_628);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_628)].join(''));
} else {
var path_629 = clojure.browser.repl.goog$module$goog$object.get.call(null,goog.dependencies_.nameToPath,src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.visited,path_629);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,path_629);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_629)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__630 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__631 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__631);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__630);
}})()})));
}));
